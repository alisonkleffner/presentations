...
```{r plots, cache=TRUE, fig.align='center'}
...
```{r bb, fig.height=4.5, cache = TRUE}
...
anim_plot <- anim_plot_data51 %>%
  ...
  scale_fill_viridis_d() + ggtitle("Clustering Using All the Data")
...
colnames(result_cluster1_ice) = c("Cluster", 'X', "Y", "X", "Y")

#
kableExtra::kable(result_cluster1_ice, booktabs = TRUE, caption = "RMSE by Cluster for Week 1 for Interpolation Methods", escape = FALSE, align = "c") %>%
