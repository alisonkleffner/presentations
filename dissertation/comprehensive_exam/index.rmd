...
2. Develop a spatio-interpolation (ST) method to predict missing points along a trajectory 
...
Meaning, for $\left\{s_1,...,s_n\right\}$, $x$ = $(x_1,...,x_n)^T \sim MVN(\mu, \Sigma_{\theta})$
