...
`r fa_i("line-chart")` Redesinging Yield Map Plots for Comprehension and Usability
...
**Research Objectives**: Develop a lead detection method by clustering similar trajectories. Then applying the information gained from clustering to develop a model reconstructing the underlying process to estimate missing points along a trajectory.
.center[
```{r ice-pic,  results='asis', echo = F, include = T, cache = T, eval = TRUE}


i1 <- img_modal(src = "images/Ice Chunk.png", alt = " Artic Sea Ice with Crack", other=list(width="35%"))
...
**Lead Detection**: used bounding box features in K-Means clustering
