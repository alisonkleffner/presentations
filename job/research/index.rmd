...
```{r, echo=FALSE, fig.width=3, fig.height=1, out.height="40%", out.width="40%"}
...
+ Number of categorical scales should be limited to 5-7 categories
 ...
 associate a color with the correct yield category `r Citep(bib[[c("macdonald_1999")]])`
  - Practically, the load on the user’s working memory then increases the comprehensive time of the plot `r Citep(bib[[c("vanderplas2020")]])`
...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/corr-plot1.jpeg", alt = "Correlation", other=list(width="50%"))
