...
Cleveland (1984) found that 30% of graphs in *Science* has an error `r Citep(bib[[c("MIDWAY2020100141")]])`:
...
Number of categorical scales should be limited to **5-7 categories**
  ...
  - The load on the user’s working memory leads to an increase the comprehensive time of the plot `r Citep(bib[[c("vanderplas2020")]])`
...
+ Utilize what is known about perception to improve previous Yield Plots
...
+ Process
  -  Cluster regions with similar movement. The boundaries between clusters would be locations where ice cracks would form.
  - Model is developed using cluster information
...
print(bib[[c("gleicher2011","huang2009", "BRAVO2004b", "BRAVO2004a", "leaflet", "gordon_2015", "macdonald_1999", "chua_2017", "cleveland_1984", "cleveland_mcgill_1984", "brewer_2002", "map_2020")]], 
...
print(bib[[c("searcy1997precision", "vanderplas2020", "Wang2018TowardsEC", "zhang_2008", "MIDWAY2020100141", "todorovic2008gestalt")]], 
      .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear")
      )
```
</font>
