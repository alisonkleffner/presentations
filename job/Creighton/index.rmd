...
<br><br>
.medium[*Slides: https://alisonkleffner.github.io/presentations/job/Creighton/index.html#1*]
...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i2 <- img_modal(src = "images/Minard.png", alt = "Napoleon March #Map by Charles Joseph Minard",other=list(width="40%"))

i1 <- img_modal(src = "images/sun-pic.png", alt = "Life Cycle of Star",other=list(width="40%"))
...
The image above here is ordered in some of the accuracy of numerical judgement. For example, length is higher up then angle, so always prefer bar chart over pie chart.
...
print(bib[[c("gleicher2011","BRAVO2004b", "BRAVO2004a", "leaflet", "gordon_2015", "chua_2017", "cleveland_1984", "cleveland_mcgill_1984", "brewer_2002", "map_2020", "gpgp_pkg", "badgley_1961")]], 
