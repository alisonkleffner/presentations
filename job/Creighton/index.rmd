...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/annotations.png", alt = "Plot Annotations Matter!",other=list(width="70%"))
...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/plot-dff.png", alt = "Judging Vertical Distance with Non-Aligned Scales (Cleveland and McGill, 1984)",other=list(width="60%"))
...
<br>
.center[
# Other Project: Modeling Arctic Sea Ice
]
...
---
class:primary
# Future Work: Modeling Arctic Sea Ice
